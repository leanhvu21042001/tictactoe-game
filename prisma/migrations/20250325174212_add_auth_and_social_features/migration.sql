-- AlterTable
ALTER TABLE "Game" ADD COLUMN     "channelId" TEXT;
...
-- AddForeignKey
ALTER TABLE "Game" ADD CONSTRAINT "Game_channelId_fkey" FOREIGN KEY ("channelId") REFERENCES "Channel"("id") ON DELETE SET NULL ON UPDATE CASCADE;
